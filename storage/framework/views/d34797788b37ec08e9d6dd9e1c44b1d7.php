    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!--Formulario-->
            <form class="max-w-md mx-auto" method="POST" action="<?php echo e(route('store')); ?>">
            <?php echo csrf_field(); ?>
                <!--Primer Nombre-->
...
<?php /**PATH C:\Users\kf959\OneDrive\Documentos\8 Cuatrimestre\Mario\Laravel\gestion-sw\resources\views/registro_doctores.blade.php ENDPATH**/ ?>